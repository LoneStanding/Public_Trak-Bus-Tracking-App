    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!isInternetAvailable()) {
            ...
            logInButton.setOnClickListener {
                ...
                // Do something with the username and password, like validating them or initiating login process
                Toast.makeText(this, "Username: $username\nPassword: $password", Toast.LENGTH_SHORT).show()
                // Create an Intent to start the BusOnline activity
                val intent = Intent(this, BusOnline::class.java)
            ...
            signUpButton.setOnClickListener {
                ...
                //Error Handling for already signed up emails
            }
